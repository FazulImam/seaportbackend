...
export interface ApiPacketPacket extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['delivering', 'delivered', 'OnHold']>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::packet.packet': ApiPacketPacket;
